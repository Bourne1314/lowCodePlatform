...
public class SerialNumberUtil {
    ...
    public static String getHardDiskSN() {
        ...
        try {
            if (isLinux) {
                ...
                if (StringUtils.isBlank(result)) {
                    result = getSerialNumber("fdisk -l", "磁盘标识符", "：");
                }
                if (StringUtils.isBlank(result)) {
                    result = getSerialNumber("fdisk -l", "磁盘标识符", ":");
                }
     ...
     * @return
     */
    public static Set<String> getMac() {
        Set<String> macs = new HashSet<>();
        try {
            Set<String> ls = getLocalIps();
            for (String str : ls) {
    ...
    public static String makeStr(Collection<String> collection) {
        String res = "";
    ...
    public static Map<String, String> getAllSn() {
        ...
        if ("LINUX".equalsIgnoreCase(os)) {
            ...
            String mac = makeStr(SerialNumberUtil.getMac());
