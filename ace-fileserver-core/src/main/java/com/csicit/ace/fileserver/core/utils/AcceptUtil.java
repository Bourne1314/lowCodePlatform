...
public class AcceptUtil {
    ...
    public static String resolve(String accept) {
        if (StringUtils.isBlank(accept)) {
            return "";
        }
        Map<String, String> map = getMimeTypes();
        String[] suffixs = accept.split(",");
        ...
        for (String suffix : suffixs) {
            if (StringUtils.isNotEmpty(suffix)) {
                if (map.containsKey(suffix)) {
                    ...
                    mimeTypes.add(map.get(suffix));
                }
            }
        }
        return LocaleUtils.getAcceptTitle() + "|" + StringUtils.join(extensions, ',') + "|" + StringUtils.join(mimeTypes, ',');
    }
}
