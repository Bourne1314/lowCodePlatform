...
import com.csicit.ace.fileserver.core.FileException;
 ...
 * @date 2020/5/12 8:19
 */
public abstract class FileSystemException extends FileException {
    private ErrorCode errorCode;
    private static final Logger LOGGER = LoggerFactory.getLogger(FileSystemException.class);
