alter table WFI_FLOW add (APP_ID VARCHAR2(50 CHAR));
comment on column WFI_FLOW.APP_ID is '应用标识';
alter table WFD_V_FLOW add (APP_ID VARCHAR2(50 CHAR));
...
alter table WFI_FLOW_USER add (NODE_NAME VARCHAR2(50 CHAR));
