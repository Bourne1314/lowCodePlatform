...
java $JVM_OPTS -jar  $SPRING_OPTS -Dlogging.level.com.alibaba.nacos=error -Dcom.alibaba.nacos.config.log.level=error -Dcom.alibaba.nacos.naming.log.level=error /app.jar