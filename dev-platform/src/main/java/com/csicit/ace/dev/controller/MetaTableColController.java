...
@RestController
@RequestMapping("/metaTableCols")
@Api("数据列")
public class MetaTableColController extends BaseController {
    ...
    public R get(@PathVariable("id") String id) {
			MetaTableColDO instance = metaTableColService.getById(id);
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        Page<MetaTableColDO> page = new Page<>(current, size);
        IPage list = metaTableColService.page(page, MapWrapper.getEqualInstance(params));
    ...
    public List<MetaTableColDO> queryList(@RequestParam Map<String, Object> params) {
        return metaTableColService.list(MapWrapper.getEqualInstance(params));
    }
    ...
    public R save(@RequestBody MetaTableColDO instance) {
        if (metaTableColService.saveTableCol(instance)) {
    ...
    public R update(@RequestBody MetaTableColDO instance) {
        if (metaTableColService.updateTableCol(instance)) {
    ...
    public R delete(@RequestParam String id) {
        if (metaTableColService.deleteTableCol(id)) {
    ...
    public R delete(@RequestBody String[] ids) {
        if (metaTableColService.removeByIds(Arrays.asList(ids))) {
            return R.ok(InternationUtils.getInternationalMsg("DELETE_SUCCESS"));
        }
        return R.error(InternationUtils.getInternationalMsg("DELETE_FAILED"));
    }
