...
@RestController
@RequestMapping("/devUserRoles")
@Api("用户角色管理")
public class DevUserRoleController extends BaseController {
    ...
    public R get(@PathVariable("id") String id) {
        DevUserRoleDO instance = devUserRoleService.getById(id);
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        Page<DevUserRoleDO> page = new Page<>(current, size);
        IPage list = devUserRoleService.page(page, MapWrapper.getEqualInstance(params));
    ...
    public R save(@RequestBody DevUserRoleDO instance) {
        if (devUserRoleService.save(instance)) {
    ...
    public R update(@RequestBody DevUserRoleDO instance) {
        if (devUserRoleService.updateById(instance)) {
    ...
    public R delete(@RequestBody String[] ids) {
        if (devUserRoleService.removeByIds(Arrays.asList(ids))) {
