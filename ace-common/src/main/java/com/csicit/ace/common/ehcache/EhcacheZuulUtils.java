 ...
 * @author FourLeaves
 * @version V88.88
 * @date 8888/88/88 88:88
 */
@ConditionalOnExpression("'${ace.config.cache.type:redis}'.equals('ehcacheZuul')")
@Component
public class EhcacheZuulUtils implements CacheUtil {
    ...
    public Set<String> getKeys(String pattern) {
        ...
        String result = client.getForEhcacheForZuul("getKeys", params);
    ...
    public String getConfigValue(String key) {
        Map<String, Object> params = new HashMap<>();
        params.put("key", key);
        String result = client.getForEhcacheForZuul("getConfigValue", params);
        return result;
    }
    ...
    public boolean rename(String oldKey, String newKey, boolean ifHasNewKey) {
        ...
        String result = client.getForEhcacheForZuul("rename", params);
    ...
    public long getExpire(String key) {
        Map<String, Object> params = new HashMap<>();
        params.put("key", key);
        String result = client.getForEhcacheForZuul("getExpire", params);
    ...
    public String get(String key) {
        Map<String, Object> params = new HashMap<>();
        params.put("key", key);
        String result = client.getForEhcacheForZuul("get", params);
        return result;
    }
    ...
    public boolean delete(String key) {
        Map<String, Object> params = new HashMap<>();
        params.put("key", key);
        String result = client.getForEhcacheForZuul("delete", params);
        return Boolean.parseBoolean(result);
    }
    ...
    public boolean expire(String key, long time) {
        ...
        String result = client.getForEhcacheForZuul("expire", params);
        return Boolean.parseBoolean(result);
    }
    ...
    public boolean hasKey(String key) {
        Map<String, Object> params = new HashMap<>();
        params.put("key", key);
        String result = client.getForEhcacheForZuul("hasKey", params);
        return Boolean.parseBoolean(result);
    }
